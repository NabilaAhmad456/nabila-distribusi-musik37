          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-white/5 backdrop-blur-sm border rounded-xl p-8 hover:bg-white/10 transition-all duration-300 ${
                plan.popular ? "border-purple-400 scale-105" : "border-white/10"
              }`}
            >
              {plan.popular && (
              ...
              {plan.limitations.length > 0 && (
                <div className="mb-8">
                  <h4 className="text-gray-400 font-semibold mb-4">Batasan:</h4>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-semibold">GoPay</p>
